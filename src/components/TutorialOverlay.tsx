...
export const TutorialOverlay: React.FC<TutorialOverlayProps> = ({ tutorialStep }) => {
    ...
    if (tutorialStep === 0) {
        ...
        message = "Great bid! Now it's Scallywag's turn. Will he raise your bid, or call you a Liar?";
    } else if (tutorialStep === 4) {
        message = "Scallywag called you a Liar! But you were telling the truth, and he had some 3s too. The total count was 4, more than your bid of 2. Scallywag loses a die! That's the basics. You can add some bots to play against in a regular room for more practice. Click 'Next Round' to end the tutorial.";
    }
