...
export const TutorialOverlay: React.FC<TutorialOverlayProps> = ({ tutorialStep }) => {
    ...
    if (tutorialStep === 0) {
        ...
        message = "Scallywag called you a Liar! But you were telling the truth, and he had some 3s too. The total count was 4, more than your bid of 2. Scallywag loses a die! That's the basics. Click 'Next Round' to end the tutorial.";
    }
